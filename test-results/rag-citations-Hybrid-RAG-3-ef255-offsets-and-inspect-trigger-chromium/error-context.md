...
- Name: rag-citations.spec.ts >> Hybrid RAG, 3D Citations & Markdown Engine >> deck: renders 3D stacked citation deck with depth offsets and inspect trigger
- Location: tests\e2e\rag-citations.spec.ts:56:7
