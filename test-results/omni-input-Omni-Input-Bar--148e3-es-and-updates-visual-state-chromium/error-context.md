...
- Name: omni-input.spec.ts >> Omni-Input Bar & Enterprise Controls E2E Suite >> 2. Web Search toggle activates and updates visual state
- Location: tests\e2e\omni-input.spec.ts:38:7
